...
if   "CMSSW_5_3_" in os.environ['CMSSW_VERSION']:
    ...
    process.GlobalTag.globaltag = cms.string('MCRUN2_74_V7D')
    process.source.fileNames = [
...
process.tpPairs = cms.EDProducer("CandViewShallowCloneCombiner",
    cut = cms.string('2 < mass && abs(daughter(0).vz - daughter(1).vz) < 4'), 
...
process.bestPairByJpsiMass = process.bestPairByZMass.clone(mass = 3.1) 
...
process.tpPairsSta = process.tpPairs.clone(decay = "tagMuons@+ probeMuonsSta@-", cut = '0 < mass < 7') 
